...
export default () => {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-1 md:py-4">
      <div className="flex items-center justify-center md:justify-center">
        ...
        <Link to="/main" className="font-bold text-gray-700 text-2xl">Shop.</Link>
  
        <div className="hidden md:flex space-x-3 flex-1 lg:ml-8">
          <Link to="/main" className="px-2 py-2 hover:bg-gray-100 rounded-lg text-gray-400 hover:text-gray-600">Electronics</Link>
